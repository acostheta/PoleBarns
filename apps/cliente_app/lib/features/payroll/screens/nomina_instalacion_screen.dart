                ...
                return StreamBuilder<List<Map<String, dynamic>>>(
                    ...
                    builder: (context, empSnapshot) {
                      ...
                      final items = snapshot.data!.where((item) {
                        if (item.fechaCulminacion == null || !isDateInFilterRange(item.fechaCulminacion, periodFilter)) return false;
          ...
          children: [
                ...
                return usersAsync.when(
                  data: (users) {
                    ...
                    final filteredEmployees = users.where((u) {
                      ...
                      return posName.contains('instalador');
                    }).toList();
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                final field1 = _buildTextField('Pago Proyecto', _pagoCtrl,
                    keyboardType:
                        const TextInputType.numberWithOptions(decimal: true),
                    prefixText: '\$ ');
                final field2 = _buildTextField('Descuentos', _discountCtrl,
                    keyboardType:
                        const TextInputType.numberWithOptions(decimal: true),
                    prefixText: '\$ ');
