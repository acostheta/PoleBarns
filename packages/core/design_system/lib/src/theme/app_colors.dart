...
class AppColors {
  ...
  static const Color primaryLight = Color(0xFF2D4B3B);
  static const Color secondaryLight = Color(0xFF9E7A2E);

  // Accent - Green (Legacy or specialized)
  static const Color accentGreen = Color(0xFF166534); // green-800
  static const Color accentGreenLight = Color(0xFFDCFCE7); // green-100
  static const Color accentGreenDark = Color(0xFF14532D); // green-900
  ...
  // Text
  static const Color textLight = Color(0xFF173124); // Brand color for text
  static const Color textMuted = Color(0x80173124); // Muted brand color

  // Stone (for borders/inputs/neutral elements)
